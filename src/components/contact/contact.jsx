...
const Contact = () => (
  <div className="newsletterglobal" id="contact">
      ...
      <div className="row grey lighten-5">
        ...
        <form className="col s12 m6 offset-m6">
          ...
          <div className="input-field left-align col s12">
            <input id="first_namee" type="text" className="validate" />
          ...
          <div className="input-field col s12">
            <input id="mailcontact" type="email" className="validate" />
            <label Htmlfor="mailcontact">Email*</label>
          </div>
          <div className="input-field col s12">
            <input id="entreprise" type="text" className="validate" />
