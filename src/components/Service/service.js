        ...
        <div className="row">
          ...
          <div className="col s12 m6 l4">
            <div className="card">
              ...
              <div className="card-content">
                <p className="left-align"><b>Ecriture d'articles</b></p>
                <hr />
                <p className="left-align">Nous écrivons des articles de blog (thématisés, B2B, B2C), des articles actualités, et nous faisons aussi du guest blogging.</p>
                <br />
              </div>
            </div>
          ...
          <div className="col s12 m6 l4">
            <div className="card">
              ...
              <div className="card-content">
                <p className="left-align"><b>Ecriture de page "A propos"</b></p>
                <hr />
        ...
        {/* fin service 2 */}
           ...
           <div className="col s12 m6 l4">
            <div className="card">
              ...
              <div className="card-content">
                <p className="left-align"><b>Consulting éditorial</b></p>
                <hr />
